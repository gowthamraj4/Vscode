...
# categorical format" refers to representing labels in a format suitable for models that perform multi-class
# classification. The two common formats for categorical labels are one-hot encoding and integer encoding.
